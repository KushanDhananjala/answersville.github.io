...
@Component({
  selector: 'app-mostly-voted-questions',
  templateUrl: './mostly-voted-questions.component.html',
  styleUrls: ['./mostly-voted-questions.component.css']
})
export class MostlyVotedQuestionsComponent implements OnInit {

  loggedUser: User = new User();
  logged: boolean = false;

  mostlyVotedQuestions: Array<CustomQuestion> = [];
  ...
  loadMostlyVotedQuestions(): void {
    this.questionService.loadMostlyVotedQuestions().subscribe(
      (result) => {
        this.mostlyVotedQuestions = result;
