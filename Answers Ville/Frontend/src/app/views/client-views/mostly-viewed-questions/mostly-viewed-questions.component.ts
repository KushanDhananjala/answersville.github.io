...
@Component({
  selector: 'app-mostly-viewed-questions',
  templateUrl: './mostly-viewed-questions.component.html',
  styleUrls: ['./mostly-viewed-questions.component.css']
})
export class MostlyViewedQuestionsComponent implements OnInit {

  loggedUser: User = new User();
  logged: boolean = false;

  mostlyViewedQuestions: Array<CustomQuestion> = [];
  ...
  ngOnInit() {
    this.loadMostlyViewedQuestions();
  ...
  loadMostlyViewedQuestions(): void {
    this.questionService.loadMostlyViewedQuestions().subscribe(
      (result) => {
        this.mostlyViewedQuestions = result;
