!function ($) {
  ...
  function nv_showNavi(t, e, s) {
    ...
    if ("show" == e || "hide" == e) o = e; else if (i > e) {
  ...
  function nv_enableNavi(t, e, s) {
    if (!t.circular && !t.infinite) {
      var i = ("removeClass" == e || "addClass" == e) && e, o = cf_c("disabled", s);
  ...
  function bt_pauseOnHoverConfig(t) {
    if (is_string(t)) var e = t.indexOf("immediate") > -1, s = t.indexOf("resume") > -1; else e = s = !1;
    return [e, s]
  }
  ...
  $.fn.carouFredSel || ($.fn.caroufredsel = $.fn.carouFredSel = function (options, configs) {
    ...
    FN._init = function (t, e, s) {
      ...
      if (is_true(opts.cookie) && (opts.cookie = "caroufredsel_cookie_" + conf.serialNumber), opts.maxDimension = ms_getMaxDimension(opts, o), opts.items = in_complementItems(opts.items, opts, i, s), opts[opts.d.width] = in_complementPrimarySize(opts[opts.d.width], opts, i), opts[opts.d.height] = in_complementSecondarySize(opts[opts.d.height], opts, i), opts.responsive && (is_percentage(opts[opts.d.width]) || (opts[opts.d.width] = "100%")), is_percentage(opts[opts.d.width]) && (crsl.upDateOnWindowResize = !0, crsl.primarySizePercentage = opts[opts.d.width], opts[opts.d.width] = ms_getPercentage(o, crsl.primarySizePercentage), opts.items.visible || (opts.items.visibleConf.variable = !0)), opts.responsive ? (opts.usePadding = !1, opts.padding = [0, 0, 0, 0], opts.align = !1, opts.items.visibleConf.variable = !1) : (opts.items.visible || (opts = in_complementVisibleItems(opts, o)), opts[opts.d.width] || (!opts.items.visibleConf.variable && is_number(opts.items[opts.d.width]) && "*" == opts.items.filter ? (opts[opts.d.width] = opts.items.visible * opts.items[opts.d.width], opts.align = !1) : opts[opts.d.width] = "variable"), is_undefined(opts.align) && (opts.align = !!is_number(opts[opts.d.width]) && "center"), opts.items.visibleConf.variable && (opts.items.visible = gn_getVisibleItemsNext(i, opts, 0))), "*" == opts.items.filter || opts.items.visibleConf.variable || (opts.items.visibleConf.org = opts.items.visible, opts.items.visible = gn_getVisibleItemsNextFilter(i, opts, 0)), opts.items.visible = cf_getItemsAdjust(opts.items.visible, opts, opts.items.visibleConf.adjust, $tt0), opts.items.visibleConf.old = opts.items.visible, opts.responsive) opts.items.visibleConf.min || (opts.items.visibleConf.min = opts.items.visible), opts.items.visibleConf.max || (opts.items.visibleConf.max = opts.items.visible), opts = in_getResponsiveValues(opts, i); else switch (opts.padding = cf_getPadding(opts.padding), "top" == opts.align ? opts.align = "left" : "bottom" == opts.align && (opts.align = "right"), opts.align) {
        case"center":
        case"left":
        case"right":
      ...
      FN._unbind_events(), $cfs.bind(cf_e("stop", conf), function (t, e) {
        ...
        if (crsl.isPaused || crsl.isScrolling || s && (tmrs.timePassed += getTime() - tmrs.startTime), crsl.isPaused || opts.auto.button && opts.auto.button.addClass(cf_c("paused", conf)), crsl.isPaused = !0, opts.auto.onTimeoutPause) {
          var o = opts.auto.timeoutDuration - tmrs.timePassed, n = 100 - Math.ceil(100 * o / opts.auto.timeoutDuration);
        ...
        return dur2 = n - tmrs.timePassed, perc = 100 - Math.ceil(100 * dur2 / n), opts.auto.progress && (tmrs.progress = setInterval(function () {
          var t = getTime() - tmrs.startTime + tmrs.timePassed, e = Math.ceil(100 * t / n);
        ...
        if (!is_number(s)) {
          if ("*" != opts.items.filter) s = "visible"; else for (var c = [s, e.items, opts[r].items], a = 0, f = c.length; f > a; a++) if (is_number(c[a]) || "page" == c[a] || "visible" == c[a]) {
            s = c[a];
            break
          }
          switch (s) {
        ...
        if (tmrs.timePassed = 0, $cfs.trigger(cf_e("slide_" + r, conf), [e, s]), opts.synchronise) for (var l = opts.synchronise, u = [e, s], p = 0, f = l.length; f > p; p++) {
          var d = r;
        ...
        var r = gi_getOldItemsPrev(i = $cfs.children(), opts, s), c = gi_getNewItemsPrev(i, opts), a = i.eq(s - 1),
          f = r.last(), l = c.last();
        ...
        var v = !1, h = ms_getTotalSize(i.slice(0, s), opts, "width"),
          w = cf_mapWrapperSizes(ms_getSizes(c, opts, !0), opts, !opts.usePadding), P = 0, C = {}, x = {}, S = {},
          y = {}, I = {}, z = {}, j = {}, N = sc_getDuration(e, opts, s, h);
        switch (e.fx) {
          case"cover":
          case"cover-fade":
        ...
        switch (D = function () {
          ...
          case"fade":
            scrl.anims.push([$cfs, {opacity: 0}, function () {
              k(), T(), F(), H(), R(), V(), (scrl = sc_setScroll(N, e.easing, conf)).anims.push([$cfs, {opacity: 1}, D]), sc_startScroll(scrl, conf)
            }]);
            break;
          case"crossfade":
        ...
        if (sz_resetMargin(i, opts), !is_number(s)) {
          if ("*" != opts.items.filter) {
            r = is_number(e.items) ? e.items : gn_getVisibleOrg($cfs, opts);
            s = gn_getScrollItemsNextFilter(i, opts, 0, r)
          } else s = opts.items.visible;
          s = cf_getAdjust(s, opts, e.items, $tt0)
        }
        var o = 0 == itms.first ? itms.total : itms.first;
        if (!opts.circular) {
          if (opts.items.visibleConf.variable) var n = gn_getVisibleItemsNext(i, opts, s),
            r = gn_getVisibleItemsPrev(i, opts, o - 1); else var n = opts.items.visible, r = opts.items.visible;
          s + n > o && (s = o - r)
        }
        if (opts.items.visibleConf.old = opts.items.visible, opts.items.visibleConf.variable) {
          for (n = cf_getItemsAdjust(gn_getVisibleItemsNextTestCircular(i, opts, s, o), opts, opts.items.visibleConf.adjust, $tt0); opts.items.visible - s >= n && itms.total > s;) s++, n = cf_getItemsAdjust(gn_getVisibleItemsNextTestCircular(i, opts, s, o), opts, opts.items.visibleConf.adjust, $tt0);
          opts.items.visible = n
        } else if ("*" != opts.items.filter) {
          n = gn_getVisibleItemsNextFilter(i, opts, s);
          opts.items.visible = cf_getItemsAdjust(n, opts, opts.items.visibleConf.adjust, $tt0)
        }
        if (sz_resetMargin(i, opts, !0), 0 == s) return t.stopImmediatePropagation(), debug(conf, "0 items to scroll: Not scrolling.");
        ...
        var c = gi_getOldItemsNext(i = $cfs.children(), opts), a = gi_getNewItemsNext(i, opts, s), f = i.eq(s - 1),
          l = c.last(), u = a.last();
        sz_resetMargin(i, opts);
        var p = 0, d = 0;
        if (opts.align) {
        ...
        var v = !1, h = ms_getTotalSize(i.slice(0, s), opts, "width"),
          w = cf_mapWrapperSizes(ms_getSizes(a, opts, !0), opts, !opts.usePadding), P = 0, C = {}, x = {}, S = {},
          y = {}, I = {}, z = sc_getDuration(e, opts, s, h);
        switch (e.fx) {
          case"uncover":
          case"uncover-fade":
        ...
        switch (F = function () {
          ...
          case"fade":
            scrl.anims.push([$cfs, {opacity: 0}, function () {
              j(), k(), T(), H(), A(), (scrl = sc_setScroll(z, e.easing, conf)).anims.push([$cfs, {opacity: 1}, F]), sc_startScroll(scrl, conf)
            }]);
            break;
          case"crossfade":
        ...
        return o = c[3], n = c[4], r = c[5], 0 != (e = gn_getItemIndex(c[0], c[1], c[2], itms, $cfs)) && (is_object(o) || (o = !1), "prev" != n && "next" != n && (n = opts.circular ? itms.total / 2 >= e ? "next" : "prev" : 0 == itms.first || itms.first > e ? "next" : "prev"), "prev" == n && (e = itms.total - e), $cfs.trigger(cf_e(n, conf), [o, e, r]), !0)
        ...
        var r = s, c = "before";
        "end" == s ? i ? (0 == itms.first ? (s = itms.total - 1, c = "after") : (s = itms.first, itms.first += e.length), 0 > s && (s = 0)) : (s = itms.total - 1, c = "after") : s = gn_getItemIndex(s, o, i, itms, $cfs);
        var a = $cfs.children().eq(s);
        return a.length ? a[c](e) : (debug(conf, "Correct insert-position not found! Appending item to the end."), $cfs.append(e)), "end" == r || i || itms.first > s && (itms.first += e.length), itms.total = $cfs.children().length, itms.first >= itms.total && (itms.first -= itms.total), $cfs.trigger(cf_e("updateSizes", conf)), $cfs.trigger(cf_e("linkAnchors", conf)), !0
      }), $cfs.bind(cf_e("removeItem", conf), function (t, e, s, i) {
        t.stopPropagation();
        var o = cf_sortParams([e, s, i], ["string/number/object", "boolean", "number"]);
        if (e = o[0], s = o[1], i = o[2], e instanceof $ && e.length > 1) return n = $(), e.each(function () {
          var t = $cfs.trigger(cf_e("removeItem", conf), [$(this), s, i]);
          t && (n = n.add(t))
        }), n;
        if (is_undefined(e) || "end" == e) n = $cfs.children().last(); else {
          e = gn_getItemIndex(e, i, s, itms, $cfs);
          var n = $cfs.children().eq(e);
          n.length && itms.first > e && (itms.first -= n.length)
        }
        ...
        if (t.stopPropagation(), 0 == itms.first) s = 0; else var s = itms.total - itms.first;
        ...
        return 0 > (s = 0 == itms.first ? 0 : itms.first < itms.total % i ? 0 : itms.first != i || opts.circular ? Math.round((itms.total - itms.first) / i) : o) && (s = 0), s > o && (s = o), is_function(e) && e.call($tt0, s), s
        ...
        if (itms.total = e.length, crsl.primarySizePercentage ? (opts.maxDimension = s, opts[opts.d.width] = ms_getPercentage(s, crsl.primarySizePercentage)) : opts.maxDimension = ms_getMaxDimension(opts, s), opts.responsive ? (opts.items.width = opts.items.sizesConf.width, opts.items.height = opts.items.sizesConf.height, opts = in_getResponsiveValues(opts, e), t = opts.items.visible, sz_setResponsiveSizes(opts, e)) : opts.items.visibleConf.variable ? t = gn_getVisibleItemsNext(e, opts, 0) : "*" != opts.items.filter && (t = gn_getVisibleItemsNextFilter(e, opts, 0)), !opts.circular && 0 != itms.first && t > itms.first) {
          if (opts.items.visibleConf.variable) i = gn_getVisibleItemsPrev(e, opts, itms.first) - itms.first; else if ("*" != opts.items.filter) i = gn_getVisibleItemsPrevFilter(e, opts, itms.first) - itms.first; else var i = opts.items.visible - itms.first;
    ...
    var crsl = {direction: "next", isPaused: !0, isScrolling: !1, isStopped: !1, mousewheel: !1, swipe: !1},
      ...
      scrl = {isStopped: !1, duration: 0, startTime: 0, easing: "", anims: []}, clbk = {onBefore: [], onAfter: []},
    ...
    if (opts.cookie && start_arr.unshift(parseInt(cf_getCookie(opts.cookie), 10)), start_arr.length > 0) for (var a = 0, l = start_arr.length; l > a; a++) {
      ...
      if (0 != s) {
        if (!0 === s) {
          if (1 > (s = window.location.hash).length) continue
