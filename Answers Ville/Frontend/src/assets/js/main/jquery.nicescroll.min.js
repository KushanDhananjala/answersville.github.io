!function (e) {
  ...
  var o = !1, t = !1, i = 5e3, r = 2e3, n = 0, s = ["ms", "moz", "webkit", "o"], l = window.requestAnimationFrame || !1,
  ...
  var u = window.MutationObserver || window.WebKitMutationObserver || !1, h = {
    ...
    scriptpath: function () {
      ...
      return 0 < (e = e[e.length - 1].src.split("?")[0]).split("/").length ? e.split("/").slice(0, -1).join("/") + "/" : ""
    }()
  }, p = !1, m = function () {
    if (p) return p;
    var e = document.createElement("DIV"),
      o = {haspointerlock: "pointerLockElement" in document || "mozPointerLockElement" in document || "webkitPointerLockElement" in document};
    ...
    for (var t = ["transform", "msTransform", "webkitTransform", "MozTransform", "OTransform"], i = 0; i < t.length; i++) if (void 0 !== e.style[t[i]]) {
      o.trstyle = t[i];
      break
    }
    ...
    for (var t = "transition webkitTransition MozTransition OTransition OTransition msTransition KhtmlTransition".split(" "), r = " -webkit- -moz- -o- -o -ms- -khtml-".split(" "), n = "transitionend webkitTransitionEnd transitionend otransitionend oTransitionEnd msTransitionEnd KhtmlTransitionEnd".split(" "), i = 0; i < t.length; i++) if (t[i] in e.style) {
    ...
    e:{
      for (t = ["-moz-grab", "-webkit-grab", "grab"], (o.ischrome && !o.ischrome22 || o.isie) && (t = []), i = 0; i < t.length; i++) if (r = t[i], e.style.cursor = r, e.style.cursor == r) {
        t = r;
        break e
      }
      t = "url(https://www.google.com/intl/en_ALL/mapfiles/openhand.cur),n-resize"
    }
    ...
    function w(e, o, t) {
      var i, r;
      if (0 == e.deltaMode ? (i = -Math.floor(e.deltaX * (v.opt.mousescrollstep / 54)), r = -Math.floor(e.deltaY * (v.opt.mousescrollstep / 54))) : 1 == e.deltaMode && (i = -Math.floor(e.deltaX * v.opt.mousescrollstep), r = -Math.floor(e.deltaY * v.opt.mousescrollstep)), o && v.opt.oneaxismousemode && 0 == i && r && (i = r, r = 0), i && (v.scrollmom && v.scrollmom.stop(), v.lastdeltax += i, v.debounced("mousewheelx", function () {
        var e = v.lastdeltax;
        v.lastdeltax = 0, v.rail.drag || v.doScrollLeftBy(e)
      }, 15)), r) {
        if (v.opt.nativeparentscrolling && t && !v.ispage && !v.zoomactive) if (0 > r) {
          if (v.getScrollTop() >= v.page.maxh) return !0
        } else if (0 >= v.getScrollTop()) return !0;
        v.scrollmom && v.scrollmom.stop(), v.lastdeltay += r, v.debounced("mousewheely", function () {
          var e = v.lastdeltay;
    ...
    if (this.version = "3.5.4", this.name = "nicescroll", this.me = c, this.opt = {
      doc: e("body"),
      win: !1
    }, e.extend(this.opt, h), this.opt.snapbackspeed = 80, s) for (var b in v.opt) void 0 !== s[b] && (v.opt[b] = s[b]);
    ...
    this.ishwscroll = (this.canhwscroll = y.hastransform && v.opt.hwacceleration) && v.haswrapper, this.istouchcapable = !1, y.cantouch && y.ischrome && !y.isios && !y.isandroid && (this.istouchcapable = !0, y.cantouch = !1), y.cantouch && y.ismozilla && !y.isios && !y.isandroid && (this.istouchcapable = !0, y.cantouch = !1), v.opt.enablemouselockapi || (y.hasmousecapture = !1, y.haspointerlock = !1), this.delayed = function (e, o, t, i) {
      var r = v.delaylist[e], n = (new Date).getTime();
      if (!i && r && r.tt) return !1;
      r && r.tt && clearTimeout(r.tt), r && r.last + t > n && !r.tt ? v.delaylist[e] = {
        last: n + t,
        tt: setTimeout(function () {
          v && (v.delaylist[e].tt = 0, o.call())
        }, t)
      } : r && r.tt || (v.delaylist[e] = {last: n, tt: 0}, setTimeout(function () {
        o.call()
      }, 0))
    }, this.debounced = function (e, o, t) {
      var i = v.delaylist[e];
      (new Date).getTime(), v.delaylist[e] = o, i || setTimeout(function () {
        var o = v.delaylist[e];
    ...
    if (this.synched = function (e, o) {
      return v.synclist[e] = o, x || (l(function () {
        x = !1;
        for (e in v.synclist) {
          var o = v.synclist[e];
      ...
      }, y.hastranslate3d && v.opt.enabletranslate3d ? (this.setScrollTop = function (e, o) {
    ...
    this.getOffset = function () {
      if (v.isfixed) return {top: parseFloat(v.win.css("top")), left: parseFloat(v.win.css("left"))};
      ...
      if (v.ishwscroll) v.rail.css({height: v.win.innerHeight()}), v.railh && v.railh.css({width: v.win.innerWidth()}); else {
        var o = v.getOffset(), t = o.top, i = o.left, t = t + p(v.win, "border-top-width", !0);
        v.win.outerWidth(), v.win.innerWidth();
        var i = i + (v.rail.align ? v.win.outerWidth() - p(v.win, "border-right-width") - v.rail.width : p(v.win, "border-left-width")),
          r = v.opt.railoffset;
        r && (r.top && (t += r.top), v.rail.align && r.left && (i += r.left)), v.locked || v.rail.css({
          top: t,
          left: i,
          height: e ? e.h : v.win.innerHeight()
        }), v.zoom && v.zoom.css({
          top: t + 1,
          left: 1 == v.rail.align ? i - 20 : i + v.rail.width + 4
        }), v.railh && !v.locked && (t = o.top, i = o.left, e = v.railh.align ? t + p(v.win, "border-top-width", !0) + v.win.innerHeight() - v.railh.height : t + p(v.win, "border-top-width", !0), i += p(v.win, "border-left-width"), v.railh.css({
          top: e,
          left: i,
          width: v.railh.width
        }))
      ...
      var i;
      v.locked || (v.cancelEvent(e), o ? (o = t ? v.doScrollLeft : v.doScrollTop, i = t ? (e.pageX - v.railh.offset().left - v.cursorwidth / 2) * v.scrollratio.x : (e.pageY - v.rail.offset().top - v.cursorheight / 2) * v.scrollratio.y, o(i)) : (o = t ? v.doScrollLeftBy : v.doScrollBy, i = t ? v.scroll.x : v.scroll.y, e = t ? e.pageX - v.railh.offset().left : e.pageY - v.rail.offset().top, t = t ? v.view.w : v.view.h, o(i >= e ? t : -t)))
      ...
      if (y.hasmstouch && v.css(v.ispage ? e("html") : v.win, {"-ms-touch-action": "none"}), v.zindex = "auto", v.zindex = v.ispage || "auto" != v.opt.zindex ? v.opt.zindex : d() || "auto", !v.ispage && "auto" != v.zindex && v.zindex > n && (n = v.zindex), v.isie && 0 == v.zindex && "auto" == v.opt.zindex && (v.zindex = "auto"), !v.ispage || !y.cantouch && !y.isieold && !y.isie9mobile) {
        var r = v.docscroll;
        v.ispage && (r = v.haswrapper ? v.win : v.doc), y.isie9mobile || v.css(r, {"overflow-y": "hidden"}), v.ispage && y.isie7 && ("BODY" == v.doc[0].nodeName ? v.css(e("html"), {"overflow-y": "hidden"}) : "HTML" == v.doc[0].nodeName && v.css(e("body"), {"overflow-y": "hidden"})), y.isios && !v.ispage && !v.haswrapper && v.css(e("body"), {"-webkit-overflow-scrolling": "touch"});
        ...
        }), s.hborder = parseFloat(s.outerHeight() - s.innerHeight()), v.cursor = s, (b = e(document.createElement("div"))).attr("id", v.id), b.addClass("nicescroll-rails");
        var l, a, c, h = ["left", "right"];
        for (c in h) a = h[c], (l = v.opt.railpadding[a]) ? b.css("padding-" + a, l + "px") : v.opt.railpadding[a] = 0;
        if (b.append(s), b.width = Math.max(parseFloat(v.opt.cursorwidth), s.outerWidth()) + v.opt.railpadding.left + v.opt.railpadding.right, b.css({
          width: b.width + "px",
          zIndex: v.zindex,
          background: v.opt.background,
          cursor: "default"
        }), b.visibility = !0, b.scrollable = !0, b.align = "left" == v.opt.railalign ? 0 : 1, v.rail = b, s = v.rail.drag = !1, v.opt.boxzoom && !v.ispage && !y.isieold && (s = document.createElement("div"), v.bind(s, "click", v.doZoom), v.zoom = e(s), v.zoom.css({
          cursor: "pointer",
          "z-index": v.zindex,
          ...
          v.css(r, {"overflow-x": "hidden"}), (s = e(document.createElement("div"))).css({
            position: "relative",
            top: 0,
          ...
          p.attr("id", v.id + "-hr"), p.addClass("nicescroll-rails"), p.height = Math.max(parseFloat(v.opt.cursorwidth), s.outerHeight()), p.css({
            height: p.height + "px",
            zIndex: v.zindex,
            background: v.opt.background
          }), p.append(s), p.visibility = !0, p.scrollable = !0, p.align = "top" == v.opt.railvalign ? 0 : 1, v.railh = p, v.railh.drag = !1
        }
        if (v.ispage ? (b.css({
          position: "fixed",
          top: "0px",
          height: "100%"
        }), b.align ? b.css({right: "0px"}) : b.css({left: "0px"}), v.body.append(b), v.railh && (p.css({
          position: "fixed",
          left: "0px",
          width: "100%"
        }), p.align ? p.css({bottom: "0px"}) : p.css({top: "0px"}), v.body.append(p))) : (v.ishwscroll ? ("static" == v.win.css("position") && v.css(v.win, {position: "relative"}), r = "HTML" == v.win[0].nodeName ? v.body : v.win, v.zoom && (v.zoom.css({
          position: "absolute",
          top: 1,
          right: 0,
          "margin-right": b.width + 4
        }), r.append(v.zoom)), b.css({
          position: "absolute",
          top: 0
        }), b.align ? b.css({right: 0}) : b.css({left: 0}), r.append(b), p && (p.css({
          position: "absolute",
          left: 0,
          bottom: 0
        }), p.align ? p.css({bottom: 0}) : p.css({top: 0}), r.append(p))) : (v.isfixed = "fixed" == v.win.css("position"), r = v.isfixed ? "fixed" : "absolute", v.isfixed || (v.viewport = v.getViewport(v.win[0])), v.viewport && (v.body = v.viewport, 0 == /fixed|relative|absolute/.test(v.viewport.css("position")) && v.css(v.viewport, {position: "relative"})), b.css({position: r}), v.zoom && v.zoom.css({position: r}), v.updateScrollBar(), v.body.append(b), v.zoom && v.body.append(v.zoom), v.railh && (p.css({position: r}), v.body.append(p))), y.isios && v.css(v.win, {
          "-webkit-tap-highlight-color": "rgba(0,0,0,0)",
          "-webkit-touch-callout": "none"
        }), y.isie && v.opt.disableoutline && v.win.attr("hideFocus", "true"), y.iswebkit && v.opt.disableoutline && v.win.css({outline: "none"})), !1 === v.opt.autohidemode ? (v.autohidedom = !1, v.rail.css({opacity: v.opt.cursoropacitymax}), v.railh && v.railh.css({opacity: v.opt.cursoropacitymax})) : !0 === v.opt.autohidemode || "leave" === v.opt.autohidemode ? (v.autohidedom = e().add(v.rail), y.isie8 && (v.autohidedom = v.autohidedom.add(v.cursor)), v.railh && (v.autohidedom = v.autohidedom.add(v.railh)), v.railh && y.isie8 && (v.autohidedom = v.autohidedom.add(v.cursorh))) : "scroll" == v.opt.autohidemode ? (v.autohidedom = e().add(v.rail), v.railh && (v.autohidedom = v.autohidedom.add(v.railh))) : "cursor" == v.opt.autohidemode ? (v.autohidedom = e().add(v.cursor), v.railh && (v.autohidedom = v.autohidedom.add(v.cursorh))) : "hidden" == v.opt.autohidemode && (v.autohidedom = !1, v.hide(), v.locked = !1), y.isie9mobile) v.scrollmom = new g(v), v.onmangotouch = function (e) {
          e = v.getScrollTop();
          var o = v.getScrollLeft();
          if (e == v.scrollmom.lastscrolly && o == v.scrollmom.lastscrollx) return !0;
          var t = e - v.mangotouch.sy, i = o - v.mangotouch.sx;
          if (0 != Math.round(Math.sqrt(Math.pow(i, 2) + Math.pow(t, 2)))) {
            var r = 0 > t ? -1 : 1, n = 0 > i ? -1 : 1, s = +new Date;
            v.mangotouch.lazy && clearTimeout(v.mangotouch.lazy), 80 < s - v.mangotouch.tm || v.mangotouch.dry != r || v.mangotouch.drx != n ? (v.scrollmom.stop(), v.scrollmom.reset(o, e), v.mangotouch.sy = e, v.mangotouch.ly = e, v.mangotouch.sx = o, v.mangotouch.lx = o, v.mangotouch.dry = r, v.mangotouch.drx = n, v.mangotouch.tm = s) : (v.scrollmom.stop(), v.scrollmom.update(v.mangotouch.sx - i, v.mangotouch.sy - t), v.mangotouch.tm = s, t = Math.max(Math.abs(v.mangotouch.ly - e), Math.abs(v.mangotouch.lx - o)), v.mangotouch.ly = e, v.mangotouch.lx = o, 2 < t && (v.mangotouch.lazy = setTimeout(function () {
              v.mangotouch.lazy = !1, v.mangotouch.dry = 0, v.mangotouch.drx = 0, v.mangotouch.tm = 0, v.scrollmom.doMomentum(30)
            }, 100)))
          }
        }, b = v.getScrollTop(), p = v.getScrollLeft(), v.mangotouch = {
          sy: b,
          ly: b,
          dry: 0,
          sx: p,
          ...
          lazy: !1,
          tm: 0
        }, v.bind(v.docscroll, "scroll", v.onmangotouch); else {
          if (y.cantouch || v.istouchcapable || v.opt.touchbehavior || y.hasmstouch) {
            v.scrollmom = new g(v), v.ontouchstart = function (o) {
              ...
              if (v.hasmoving = !1, !v.locked) {
                if (y.hasmstouch) for (var t = !!o.target && o.target; t && !(0 < (i = e(t).getNiceScroll()).length && i[0].me == v.me);) {
                ...
                if (!("clientX" in o) && "changedTouches" in o && (o.clientX = o.changedTouches[0].clientX, o.clientY = o.changedTouches[0].clientY), v.forcescreen && (i = o, o = {original: o.original ? o.original : o}, o.clientX = i.screenX, o.clientY = i.screenY), v.rail.drag = {
                  x: o.clientX,
                  y: o.clientY,
                  sx: v.scroll.x,
                  sy: v.scroll.y,
                  ...
                  var i = e(window).width(), r = e(window).height(),
                    ...
                    r = Math.max(0, s - r), i = Math.max(0, n - i);
                  v.rail.drag.ck = !v.rail.scrollable && v.railh.scrollable ? 0 < r && "v" : !(!v.rail.scrollable || v.railh.scrollable) && (0 < i && "h"), v.rail.drag.ck || (v.rail.drag.dl = "f")
                }
                if (v.opt.touchbehavior && v.isiframe && y.isie && (i = v.win.position(), v.rail.drag.x += i.left, v.rail.drag.y += i.top), v.hasmoving = !1, v.lastmouseup = !1, v.scrollmom.reset(o.clientX, o.clientY), !y.cantouch && !this.istouchcapable && !y.hasmstouch) {
                  ...
                  /SUBMIT|CANCEL|BUTTON/i.test(e(t).attr("type")) && (pc = {tg: t, click: !1}, v.preventclick = pc)
                }
              }
            }, v.ontouchend = function (e) {
              return (!e.pointerType || 2 == e.pointerType) && (v.rail.drag && 2 == v.rail.drag.pt && (v.scrollmom.doMomentum(), v.rail.drag = !1, v.hasmoving && (v.lastmouseup = !0, v.hideCursor(), y.hasmousecapture && document.releaseCapture(), !y.cantouch)) ? v.cancelEvent(e) : void 0)
            };
            var m = v.opt.touchbehavior && v.isiframe && !y.hasmousecapture;
            v.ontouchmove = function (o, t) {
              if (o.pointerType && 2 != o.pointerType) return !1;
              if (v.rail.drag && 2 == v.rail.drag.pt) {
                if (y.cantouch && void 0 === o.original) return !0;
                if (v.hasmoving = !0, v.preventclick && !v.preventclick.click && (v.preventclick.click = v.preventclick.tg.onclick || !1, v.preventclick.tg.onclick = v.onpreventclick), "changedTouches" in (o = e.extend({original: o}, o)) && (o.clientX = o.changedTouches[0].clientX, o.clientY = o.changedTouches[0].clientY), v.forcescreen) {
                  i = o;
                  (o = {original: o.original ? o.original : o}).clientX = i.screenX, o.clientY = i.screenY
                }
                if (i = ofy = 0, m && !t) {
                  var i = -(n = v.win.position()).left;
                  ofy = -n.top
                }
                var r = o.clientY + ofy, n = r - v.rail.drag.y, s = o.clientX + i, l = s - v.rail.drag.x,
                  a = v.rail.drag.st - n;
                if (v.ishwscroll && v.opt.bouncescroll ? 0 > a ? a = Math.round(a / 2) : a > v.page.maxh && (a = v.page.maxh + Math.round((a - v.page.maxh) / 2)) : (0 > a && (r = a = 0), a > v.page.maxh && (a = v.page.maxh, r = 0)), v.railh && v.railh.scrollable) {
                ...
                if (i = !1, v.rail.drag.dl) i = !0, "v" == v.rail.drag.dl ? c = v.rail.drag.sl : "h" == v.rail.drag.dl && (a = v.rail.drag.st); else {
                  var n = Math.abs(n), l = Math.abs(l), d = v.opt.directionlockdeadzone;
                  if ("v" == v.rail.drag.ck) {
                    if (n > d && l <= .3 * n) return v.rail.drag = !1, !0;
                    l > d && (v.rail.drag.dl = "f", e("body").scrollTop(e("body").scrollTop()))
                  } else if ("h" == v.rail.drag.ck) {
                    if (l > d && n <= .3 * l) return v.rail.drag = !1, !0;
                    n > d && (v.rail.drag.dl = "f", e("body").scrollLeft(e("body").scrollLeft()))
                  }
                }
                if (v.synched("touchmove", function () {
                  v.rail.drag && 2 == v.rail.drag.pt && (v.prepareTransition && v.prepareTransition(0), v.rail.scrollable && v.setScrollTop(a), v.scrollmom.update(s, r), v.railh && v.railh.scrollable ? (v.setScrollLeft(c), v.showCursor(a, c)) : v.showCursor(a), y.isie10 && document.selection.clear())
                }), y.ischrome && v.istouchcapable && (i = !1), i) return v.cancelEvent(o)
              }
            }
          }
          if (v.onmousedown = function (e, o) {
            if (!v.rail.drag || 1 == v.rail.drag.pt) {
              ...
              var t = v.getTarget(e);
              return !v.ispage && y.hasmousecapture && t.setCapture(), v.isiframe && !y.hasmousecapture && (v.saved.csspointerevents = v.doc.css("pointer-events"), v.css(v.doc, {"pointer-events": "none"})), v.hasmoving = !1, v.cancelEvent(e)
            }
          }, v.onmouseup = function (e) {
            if (v.rail.drag && (y.hasmousecapture && document.releaseCapture(), v.isiframe && !y.hasmousecapture && v.doc.css("pointer-events", v.saved.csspointerevents), 1 == v.rail.drag.pt)) return v.rail.drag = !1, v.hasmoving && v.triggerScrollEnd(), v.cancelEvent(e)
          ...
          }, v.bind(v.win, "mousedown", v.ontouchstart), v.onclick = !y.isios && function (e) {
            return !v.lastmouseup || (v.lastmouseup = !1, v.cancelEvent(e))
          }, v.opt.grabcursorenabled && y.cursorgrabvalue && (v.css(v.ispage ? v.doc : v.win, {cursor: y.cursorgrabvalue}), v.css(v.rail, {cursor: y.cursorgrabvalue})); else {
            var f = function (e) {
              if (v.selectiondrag) {
                if (e) {
                  var o = v.win.outerHeight();
                  0 < (e = e.pageY - v.selectiondrag.top) && e < o && (e = 0), e >= o && (e -= o), v.selectiondrag.df = e
                }
          ...
          y.hasmstouch && (v.css(v.rail, {"-ms-touch-action": "none"}), v.css(v.cursor, {"-ms-touch-action": "none"}), v.bind(v.win, "MSPointerDown", v.ontouchstart), v.bind(document, "MSPointerUp", v.ontouchend), v.bind(document, "MSPointerMove", v.ontouchmove), v.bind(v.cursor, "MSGestureHold", function (e) {
            e.preventDefault()
            ...
            v.onmousedown(e, !0)
          }), v.bind(v.cursorh, "mouseup", v.onmouseup)), (v.opt.cursordragontouch || !y.cantouch && !v.opt.touchbehavior) && (v.rail.css({cursor: "default"}), v.railh && v.railh.css({cursor: "default"}), v.jqbind(v.rail, "mouseenter", function () {
            if (!v.win.is(":visible")) return !1;
            ...
            v.cancelEvent(e)
          })))), y.cantouch || v.opt.touchbehavior ? (v.bind(y.hasmousecapture ? v.win : document, "mouseup", v.ontouchend), v.bind(document, "mousemove", v.ontouchmove), v.onclick && v.bind(document, "click", v.onclick), v.opt.cursordragontouch && (v.bind(v.cursor, "mousedown", v.onmousedown), v.bind(v.cursor, "mousemove", v.onmousemove), v.cursorh && v.bind(v.cursorh, "mousedown", function (e) {
            v.onmousedown(e, !0)
            ...
            v.rail.active = !1, v.rail.drag || v.hideCursor()
          }))), v.opt.enablemousewheel && (v.isiframe || v.bind(y.isie && v.ispage ? document : v.win, "mousewheel", v.onmousewheel), v.bind(v.rail, "mousewheel", v.onmousewheel), v.railh && v.bind(v.railh, "mousewheel", v.onmousewheelhr)), !v.ispage && !y.cantouch && !/HTML|^BODY/.test(v.win[0].nodeName) && (v.win.attr("tabindex") || v.win.attr({tabindex: i++}), v.jqbind(v.win, "focus", function (e) {
        ...
        if (v.onkeypress = function (i) {
          ...
          if (v.hasfocus || v.hasmousefocus && !o || v.ispage && !o && !t) {
            if (r = i.keyCode, v.locked && 27 != r) return v.cancelEvent(i);
          ...
          var w = v.win.attr("style"), b = parseFloat(v.win.css("width")) + 1;
          v.win.css("width", b), v.synched("chromefix", function () {
            v.win.attr("style", w)
          })
        }
        v.onAttributeChange = function (e) {
          ...
          e.forEach(function (e) {
            if (0 < e.removedNodes.length) for (var o in e.removedNodes) if (e.removedNodes[o] == v.win[0]) return v.remove()
          })
      ...
      if ("IFRAME" == this.doc[0].nodeName) {
        var x = function (o) {
          ...
          v.forcescreen = !0, v.isiframe && (v.iframe = {
            doc: e(t),
          ...
          }, v.docscroll = e(v.iframe.body)), !y.isios && v.opt.iframeautoresize && !v.isiframe && (v.win.scrollTop(0), v.doc.height(""), o = Math.max(t.getElementsByTagName("html")[0].scrollHeight, t.body.scrollHeight), v.doc.height(o)), v.lazyResize(30), y.isie7 && v.css(e(v.iframe.html), {"overflow-y": "hidden"}), v.css(e(v.iframe.body), {"overflow-y": "hidden"}), y.isios && v.haswrapper && v.css(e(t.body), {"-webkit-transform": "translate3d(0,0,0)"}), "contentWindow" in this ? v.bind(this.contentWindow, "scroll", v.onscroll) : v.bind(t, "scroll", v.onscroll), v.opt.enablemousewheel && v.bind(t, "mousewheel", v.onmousewheel), v.opt.enablekeyboard && v.bind(t, y.isopera ? "keypress" : "keydown", v.onkeypress), (y.cantouch || v.opt.touchbehavior) && (v.bind(t, "mousedown", v.ontouchstart), v.bind(t, "mousemove", function (e) {
            v.ontouchmove(e, !0)
          }), v.opt.grabcursorenabled && y.cursorgrabvalue && v.css(e(t.body), {cursor: y.cursorgrabvalue})), v.bind(t, "mouseup", v.ontouchend), v.zoom && (v.opt.dblclickzoom && v.bind(t, "dblclick", v.doZoom), v.ongesturezoom && v.bind(t, "gestureend", v.ongesturezoom))
        };
      ...
      v.cursortimeout && (clearTimeout(v.cursortimeout), v.cursortimeout = 0), v.rail && (v.autohidedom && (v.autohidedom.stop().css({opacity: v.opt.cursoropacitymax}), v.cursoractive = !0), v.rail.drag && 1 == v.rail.drag.pt || (void 0 !== e && !1 !== e && (v.scroll.y = Math.round(1 * e / v.scrollratio.y)), void 0 !== o && (v.scroll.x = Math.round(1 * o / v.scrollratio.x))), v.cursor.css({
        ...
        width: v.cursorwidth,
        left: v.scroll.x
      }), v.cursoractive = !0), v.zoom && v.zoom.stop().css({opacity: v.opt.cursoropacitymax}))
      ...
      var t = v.page.maxh, i = v.page.maxw, r = v.view.w;
      if (v.view = {
        w: v.ispage ? v.win.width() : parseInt(v.win[0].clientWidth),
        h: v.ispage ? v.win.height() : parseInt(v.win[0].clientHeight)
      }, v.page = o || v.getContentSize(), v.page.maxh = Math.max(0, v.page.h - v.view.h), v.page.maxw = Math.max(0, v.page.w - v.view.w), v.page.maxh == t && v.page.maxw == i && v.view.w == r) {
        if (v.ispage) return v;
        if (t = v.win.offset(), v.lastposition && (i = v.lastposition).top == t.top && i.left == t.left) return v;
        v.lastposition = t
      }
      return 0 == v.page.maxh ? (v.hideRail(), v.scrollvaluemax = 0, v.scroll.y = 0, v.scrollratio.y = 0, v.cursorheight = 0, v.setScrollTop(0), v.rail.scrollable = !1) : v.rail.scrollable = !0, 0 == v.page.maxw ? (v.hideRailHr(), v.scrollvaluemaxw = 0, v.scroll.x = 0, v.scrollratio.x = 0, v.cursorwidth = 0, v.setScrollLeft(0), v.railh.scrollable = !1) : v.railh.scrollable = !0, v.locked = 0 == v.page.maxh && 0 == v.page.maxw, v.locked ? (v.ispage || v.updateScrollBar(v.view), !1) : (v.hidden || v.visibility ? !v.hidden && !v.railh.visibility && v.showRailHr() : v.showRail().showRailHr(), v.istextarea && v.win.css("resize") && "none" != v.win.css("resize") && (v.view.h -= 20), v.cursorheight = Math.min(v.view.h, Math.round(v.view.h * (v.view.h / v.page.h))), v.cursorheight = v.opt.cursorfixedheight ? v.opt.cursorfixedheight : Math.max(v.opt.cursorminheight, v.cursorheight), v.cursorwidth = Math.min(v.view.w, Math.round(v.view.w * (v.view.w / v.page.w))), v.cursorwidth = v.opt.cursorfixedheight ? v.opt.cursorfixedheight : Math.max(v.opt.cursorminheight, v.cursorwidth), v.scrollvaluemax = v.view.h - v.cursorheight - v.cursor.hborder, v.railh && (v.railh.width = 0 < v.page.maxh ? v.view.w - v.rail.width : v.view.w, v.scrollvaluemaxw = v.railh.width - v.cursorwidth - v.cursorh.wborder), v.ispage || v.updateScrollBar(v.view), v.scrollratio = {
      ...
      v.events.push({e: o, n: t, f: i, q: !0}), e(o).bind(t, i)
    }, this.bind = function (e, o, t, i) {
      var r = "jquery" in e ? e[0] : e;
      "mousewheel" == o ? "onwheel" in v.win ? v._bind(r, "wheel", t, i || !1) : (e = void 0 !== document.onmousewheel ? "mousewheel" : "DOMMouseScroll", f(r, e, t, i || !1), "DOMMouseScroll" == e && f(r, "MozMousePixelScroll", t, i || !1)) : r.addEventListener ? (y.cantouch && /mouseup|mousedown|mousemove/.test(o) && v._bind(r, "mousedown" == o ? "touchstart" : "mouseup" == o ? "touchend" : "touchmove", function (e) {
        if (e.touches) {
      ...
      }, i || !1), v._bind(r, o, t, i || !1), y.cantouch && "mouseup" == o && v._bind(r, "touchcancel", t, i || !1)) : v._bind(r, o, function (e) {
        return (e = e || window.event || !1) && e.srcElement && (e.target = e.srcElement), "pageY" in e || (e.pageX = e.clientX + document.documentElement.scrollLeft, e.pageY = e.clientY + document.documentElement.scrollTop), !1 !== t.call(r, e) && !1 !== i || v.cancelEvent(e)
      })
      ...
      return !!(e = e.original ? e.original : e || (window.event || !1)) && (e.preventDefault && e.preventDefault(), e.stopPropagation && e.stopPropagation(), e.preventManipulation && e.preventManipulation(), e.cancelBubble = !0, e.cancel = !0, e.returnValue = !1)
      ...
      if ("OPTION" == (o = o.target ? o.target : o).nodeName) return !0;
      for (; o && 1 == o.nodeType && !/^BODY|HTML/.test(o.nodeName);) {
        var t = (t = e(o)).css("overflowY") || t.css("overflowX") || t.css("overflow") || "";
      ...
      if (v.onscrollend) {
        ...
        v.onscrollend.call(v, {type: "scrollend", current: {x: e, y: o}, end: {x: e, y: o}})
      }
      ...
      if (!v.wheelprevented) {
        ...
        if (v.rail.drag) return v.cancelEvent(e);
        var o = +new Date, t = !1;
        return v.opt.preservenativescrolling && v.checkarea + 600 < o && (v.nativescrollingarea = v.isScrollable(e), t = !0), v.checkarea = o, !!v.nativescrollingarea || (v.locked ? v.cancelEvent(e) : w(e, !0, t))
      }
    }, this.stop = function () {
      ...
      return e = Math.min(o, Math.round(e / 20 * v.opt.scrollspeed)), 20 < e ? e : 0
    }, v.opt.smoothscroll ? v.ishwscroll && y.hastransition && v.opt.usetransition ? (this.prepareTransition = function (e, o) {
      var t = o ? 20 < e ? e : 0 : v.getTransitionSpeed(e),
        i = t ? y.prefixstyle + "transform " + t + "ms ease-out" : "";
      return v.lasttransitionstyle && v.lasttransitionstyle == i || (v.lasttransitionstyle = i, v.doc.css(y.transitionstyle, i)), t
      ...
      var i = v.getScrollTop(), r = v.getScrollLeft();
      return (0 > (v.newscrolly - i) * (o - i) || 0 > (v.newscrollx - r) * (e - r)) && v.cancelScroll(), 0 == v.opt.bouncescroll && (0 > o ? o = 0 : o > v.page.maxh && (o = v.page.maxh), 0 > e ? e = 0 : e > v.page.maxw && (e = v.page.maxw)), (!v.scrollrunning || e != v.newscrollx || o != v.newscrolly) && (v.newscrolly = o, v.newscrollx = e, v.newscrollspeed = t || !1, !v.timer && void(v.timer = setTimeout(function () {
        var t, i, r = v.getScrollTop(), n = v.getScrollLeft();
        t = e - n, i = o - r, t = Math.round(Math.sqrt(Math.pow(t, 2) + Math.pow(i, 2))), t = v.newscrollspeed && 1 < v.newscrollspeed ? v.newscrollspeed : v.getTransitionSpeed(t), v.newscrollspeed && 1 >= v.newscrollspeed && (t *= v.newscrollspeed), v.prepareTransition(t, !0), v.timerscroll && v.timerscroll.tm && clearInterval(v.timerscroll.tm), 0 < t && (!v.scrollrunning && v.onscrollstart && v.onscrollstart.call(v, {
          type: "scrollstart",
          current: {x: n, y: r},
          request: {x: e, y: o},
          end: {x: v.newscrollx, y: v.newscrolly},
          speed: t
        }), y.transitionend ? v.scrollendtrapped || (v.scrollendtrapped = !0, v.bind(v.doc, y.transitionend, v.onScrollTransitionEnd, !1)) : (v.scrollendtrapped && clearTimeout(v.scrollendtrapped), v.scrollendtrapped = setTimeout(v.onScrollTransitionEnd, t)), v.timerscroll = {
          bz: new BezierClass(r, v.newscrolly, t, 0, 0, .58, 1),
      ...
      return v.scrollrunning = !1, y.transitionend || clearTimeout(y.transitionend), v.scrollendtrapped = !1, v._unbind(v.doc, y.transitionend, v.onScrollTransitionEnd), v.prepareTransition(0), v.setScrollTop(e), v.railh && v.setScrollLeft(o), v.timerscroll && v.timerscroll.tm && clearInterval(v.timerscroll.tm), v.timerscroll = !1, v.cursorfreezed = !1, v.showCursor(e, o), v
      ...
      v.onscrollend && v.scrollrunning && v.triggerScrollEnd(), v.scrollrunning = !1
    }) : (this.doScrollLeft = function (e, o) {
      var t = v.scrollrunning ? v.newscrolly : v.getScrollTop();
      v.doScrollPos(e, t, o)
    }, this.doScrollTop = function (e, o) {
      ...
      function i() {
        ...
        if (v.scrollrunning = !0, u = 1 - u) return v.timer = l(i) || 1;
        var e = 0, o = sy = v.getScrollTop();
        if (v.dst.ay) {
          var t = (o = v.bzscroll ? v.dst.py + v.bzscroll.getNow() * v.dst.ay : v.newscrolly) - sy;
          (0 > t && o < v.newscrolly || 0 < t && o > v.newscrolly) && (o = v.newscrolly), v.setScrollTop(o), o == v.newscrolly && (e = 1)
        } else e = 1;
        var r = sx = v.getScrollLeft();
        v.dst.ax ? ((0 > (t = (r = v.bzscroll ? v.dst.px + v.bzscroll.getNow() * v.dst.ax : v.newscrollx) - sx) && r < v.newscrollx || 0 < t && r > v.newscrollx) && (r = v.newscrollx), v.setScrollLeft(r), r == v.newscrollx && (e += 1)) : e += 1, 2 == e ? (v.timer = 0, v.cursorfreezed = !1, v.bzscroll = !1, v.scrollrunning = !1, 0 > o ? o = 0 : o > v.page.maxh && (o = v.page.maxh), 0 > r ? r = 0 : r > v.page.maxw && (r = v.page.maxw), r != v.newscrollx || o != v.newscrolly ? v.doScrollPos(r, o) : v.onscrollend && v.triggerScrollEnd()) : v.timer = l(i) || 1
      }

      if (o = void 0 === o || !1 === o ? v.getScrollTop(!0) : o, v.timer && v.newscrolly == o && v.newscrollx == e) return !0;
      v.timer && a(v.timer), v.timer = 0;
      var r = v.getScrollTop(), n = v.getScrollLeft();
      (0 > (v.newscrolly - r) * (o - r) || 0 > (v.newscrollx - n) * (e - n)) && v.cancelScroll(), v.newscrolly = o, v.newscrollx = e, v.bouncescroll && v.rail.visibility || (0 > v.newscrolly ? v.newscrolly = 0 : v.newscrolly > v.page.maxh && (v.newscrolly = v.page.maxh)), v.bouncescroll && v.railh.visibility || (0 > v.newscrollx ? v.newscrollx = 0 : v.newscrollx > v.page.maxw && (v.newscrollx = v.page.maxw)), v.dst = {}, v.dst.x = e - n, v.dst.y = o - r, v.dst.px = n, v.dst.py = r;
      var s = Math.round(Math.sqrt(Math.pow(v.dst.x, 2) + Math.pow(v.dst.y, 2)));
      v.dst.ax = v.dst.x / s, v.dst.ay = v.dst.y / s;
      var c = 0, d = s;
      if (0 == v.dst.x ? (c = r, d = o, v.dst.ay = 1, v.dst.py = 0) : 0 == v.dst.y && (c = n, d = e, v.dst.ax = 1, v.dst.px = 0), s = v.getTransitionSpeed(s), t && 1 >= t && (s *= t), v.bzscroll = 0 < s && (v.bzscroll ? v.bzscroll.update(d, s) : new BezierClass(c, d, s, 0, 1, 0, 1)), !v.timer) {
        (r == v.page.maxh && o >= v.page.maxh || n == v.page.maxw && e >= v.page.maxw) && v.checkContentSize();
        var u = 1;
        v.cancelAnimationFrame = !1, v.timer = 1, v.onscrollstart && !v.scrollrunning && v.onscrollstart.call(v, {
          ...
          speed: s
        }), i(), (r == v.page.maxh && o >= r || n == v.page.maxw && e >= n) && v.checkContentSize(), v.noticeCursor()
      }
    }, this.cancelScroll = function () {
      ...
      var i = e > v.page.maxw ? v.page.maxw : e;
      0 > i && (i = 0);
      var r = o > v.page.maxh ? v.page.maxh : o;
      0 > r && (r = 0), v.synched("scroll", function () {
        v.setScrollTop(r), v.setScrollLeft(i)
      })
    }, this.cancelScroll = function () {
      ...
      if (v.bouncescroll) {
        ...
        t < -i ? t = -i : t > v.page.maxh + i && (t = v.page.maxh + i)
      }
      ...
      if (v.bouncescroll) {
        ...
        t < -i ? t = -i : t > v.page.maxw + i && (t = v.page.maxw + i)
      }
      if (v.cursorfreezed = !1, px = v.getScrollLeft(!0), 0 > t && 0 >= px || t > v.page.maxw && px >= v.page.maxw) return v.noticeCursor();
      v.doScrollLeft(t)
      ...
      if (!v.zoomactive) {
        ...
        return v.zoomrestore.style.width = v.win.css("width"), v.zoomrestore.style.height = v.win.css("height"), v.zoomrestore.padding = {
          ...
          "z-index": n + 100,
          margin: "0px"
        }), ("" == (i = v.win.css("backgroundColor")) || /transparent|rgba\(0, 0, 0, 0\)|rgba\(0,0,0,0\)/.test(i)) && v.win.css("backgroundColor", "#fff"), v.rail.css({"z-index": n + 101}), v.zoom.css({"z-index": n + 102}), v.zoom.css("backgroundPosition", "0px -18px"), v.resizeZoom(), v.onzoomin && v.onzoomin.call(v), v.cancelEvent(o)
      }
    }, this.doZoomOut = function (o) {
      if (v.zoomactive) return v.zoomactive = !1, v.win.css("margin", ""), v.win.css(v.zoomrestore.style), y.isios4 && e(window).scrollTop(v.zoomrestore.scrollTop), v.rail.css({"z-index": v.zindex}), v.zoom.css({"z-index": v.zindex}), v.zoomrestore = !1, v.zoom.css("backgroundPosition", "0px 0px"), v.onResize(), v.onzoomout && v.onzoomout.call(v), v.cancelEvent(o)
    ...
    this.nc = e, this.steptime = this.lasttime = this.speedy = this.speedx = this.lasty = this.lastx = 0, this.snapy = this.snapx = !1, this.demuly = this.demulx = 0, this.lastscrolly = this.lastscrollx = -1, this.timer = this.chky = this.chkx = 0, this.time = function () {
      ...
      var i = t - o.lasty, r = e - o.lastx, n = (n = o.nc.getScrollTop()) + i, s = (s = o.nc.getScrollLeft()) + r;
  ...
  !function (e, o, t) {
    ...
    nicescroll: function (o) {
      return !!e.data(o, "__nicescroll")
    }
  }), e.fn.niceScroll = function (o, t) {
    void 0 === t && "object" == typeof o && !("jquery" in o) && (t = o, o = !1);
    var i = new b;
