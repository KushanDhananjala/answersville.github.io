!function (t) {
  ...
  s.prototype = {
    show: function () {
      ...
      if (e && this.enabled) {
        ...
        2 == f.length && ("w" == f.charAt(1) ? n.left = o.left + o.width / 2 - 15 : n.left = o.left + o.width / 2 - l + 15), s.css(n).addClass("tipsy-" + f), s.find(".tipsy-arrow")[0].className = "tipsy-arrow tipsy-arrow-" + f.charAt(0), this.options.className && s.addClass(i(this.options.className, this.$element[0])), this.options.fade ? s.stop().css({
          ...
          display: "block",
          visibility: "visible"
        }).animate({opacity: this.options.opacity}) : s.css({visibility: "visible", opacity: this.options.opacity})
      }
    }, hide: function () {
      ...
      this.fixTitle();
      var e;
      return "string" == typeof(i = this.options).title ? e = t.attr("title" == i.title ? "original-title" : i.title) : "function" == typeof i.title && (e = i.title.call(t[0])), (e = ("" + e).replace(/(^\s*|\s*$)/, "")) || i.fallback
    }, tip: function () {
    ...
    if ((i = t.extend({}, t.fn.tipsy.defaults, i)).live || this.each(function () {
      ...
      var o = i.live ? "live" : "bind", l = "hover" == i.trigger ? "mouseenter" : "focus",
    ...
    return function () {
      var s = {ns: e[0], ew: e.length > 1 && e[1]}, n = t(document).scrollTop() + i, o = t(document).scrollLeft() + i,
        l = t(this);
