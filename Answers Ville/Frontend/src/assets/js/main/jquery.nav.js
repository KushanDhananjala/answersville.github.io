!function (n, t, i, e) {
  ...
  s.prototype = {
    defaults: {
      ...
      var t, i, e, s = this;
      s.$nav.each(function () {
        t = s.getHash(n(this)), (e = n("#" + t)).length && (i = e.offset().top, s.sections[t] = Math.round(i) - s.config.scrollOffset)
      })
      ...
      null !== i && ((n = this.$elem.find('a[href$="#' + i + '"]').parent()).hasClass(this.config.currentClass) || (this.adjustNav(this, n), this.config.scrollChange && this.config.scrollChange(n)))
    }, unbindInterval: function () {
      clearInterval(this.t), this.$win.unbind("scroll.onePageNav")
    }
  }, s.defaults = s.prototype.defaults, n.fn.onePageNav = function (n) {
